...
BOARD_KERNEL_CMDLINE := bootopt=64S3,32N2,64N2 androidboot.selinux=permissive androidboot.selinux=permissive 
BOARD_KERNEL_OFFSET = 0x00080000
BOARD_TAGS_OFFSET := 0xE000000
TARGET_USES_64_BIT_BINDER := true
BOARD_MKBOOTIMG_ARGS := --kernel_offset $(BOARD_KERNEL_OFFSET) --ramdisk_offset $(BOARD_RAMDISK_OFFSET) --tags_offset $(BOARD_TAGS_OFFSET)
TARGET_PREBUILT_KERNEL := device/Infinix/X601/kernel/kernel

#Hacck for building without kernel source
...
# Assert
TARGET_OTA_ASSERT_DEVICE := X601,X601,Infinix X601,Infinix-X601
...
# CWM
TARGET_RECOVERY_FSTAB := device/Infinix/X601/rootdir/recovery.fstab
...
TARGET_SYSTEM_PROP := device/Infinix/X601/system.prop
